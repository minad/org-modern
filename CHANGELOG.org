...
* Version 1.14 (2026-05-19)

- Add new customization option ~org-modern-cycle-stars~.
- Require Compat 31.

* Version 1.13 (2026-03-09)

- Prettify ~#+caption[short caption]: ...~

* Version 1.12 (2026-01-17)

- =org-modern-label-border=: Support functions to compute border width.
...
* Version 1.10 (2025-10-13)

- Require Emacs 29.1.
- Shorter horizontal line prettification to avoid line truncation indicators.
