...
This is a screenshot of [[file:example.org][example.org]] with =org-modern= turned on and off. The
...
enable =org-mode= for all your Org buffers, add =org-modern-mode= to the Org mode
hook list.
