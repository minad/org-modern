...
#+html: <a href="https://releases.melpa.org/#/org-modern"><img alt="MELPA Releases" src="https://releases.melpa.org/packages/org-modern-badge.svg"/></a>
#+html: <a href="https://snapshots.melpa.org/#/org-modern"><img alt="MELPA Snapshots" src="https://snapshots.melpa.org/packages/org-modern-badge.svg"/></a>
...
=org-modern-mode= tries to adjust the tag label display based on font height.

* Configuration

The package is available from [[https://elpa.gnu.org/packages/org-modern.html][ELPA]] or [[https://releases.melpa.org/#/org-modern][MELPA]]. You can install the package with
...
Furthermore I recommend to use =line-spacing= with a value between 0.1 and 0.4 to
give the text some room to breathe. From Emacs 31, the text can be centered by
setting =line-spacing= to a pair of two numbers (see Emacs [[https://debbugs.gnu.org/cgi/bugreport.cgi?bug=76390][bug#76390]]).
