...
give the text some room to breathe. Unfortunately as of Emacs 30, the text is
not centered with =line-spacing=, but I am hopeful that centering will be
available in Emacs 31 (see Emacs [[https://debbugs.gnu.org/cgi/bugreport.cgi?bug=76390][bug#76390]]).
